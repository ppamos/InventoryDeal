...
public abstract class AbstractInventoryDeal implements InventoryDealDefinition, Initialization {
    ...
    protected abstract FreezeInventoryResult doFreezeInventory(String version, Map<Long, Integer> inventoryNumMap,
    ...
    public void addInventory(Long inventoryId) {
        ...
        try {
            ...
            if (loadInventoryNum < 0) {
                inventoryLoaderResult = inventoryLoader.loadAllInventory(inventoryId);
            } else {
    ...
    private void afterFreezeInventory(String version, Map<Long, Integer> inventoryNumMap,
        Map<String, String> parameters, FreezeInventoryResult freezeInventoryResult) {
        if (CollectionUtils.isNotEmpty(freezeInventoryListeners)) {
            for (FreezeInventoryListener freezeInventoryListener : freezeInventoryListeners) {
                freezeInventoryListener.afterFreezeInventory(version, inventoryNumMap, parameters,
                    freezeInventoryResult);
            }
        }
    }

    private void onFreezeErrorDo(String version, Map<Long, Integer> inventoryNumMap, Map<String, String> parameters,
        Exception e) {
        if (CollectionUtils.isNotEmpty(freezeInventoryListeners)) {
            for (FreezeInventoryListener freezeInventoryListener : freezeInventoryListeners) {
    ...
    private void beforeFreezeInventory(String version, Map<Long, Integer> inventoryNumMap,
        Map<String, String> parameters) {
        if (CollectionUtils.isNotEmpty(freezeInventoryListeners)) {
            for (FreezeInventoryListener freezeInventoryListener : freezeInventoryListeners) {
    ...
    public void setInventoryLoader(InventoryLoader inventoryLoader) {
